...
interface DuplicatePrisonerRepository : Repository<DuplicateOffender, String> {
  ...
  fun getOffendersWithMatchingPncNumbers(offenderNo: String, formattedIds: Set<String>): List<DuplicateOffender>
  ...
  fun getOffendersWithMatchingCroNumbers(offenderNo: String, formattedIds: Set<String>): List<DuplicateOffender>
  ...
  fun getOffendersWithMatchingLidsNumbers(offenderNo: String): List<DuplicateOffender>
  ...
  fun getOffendersWithMatchingDetails(offenderNo: String): List<DuplicateOffender>
}
